...
```
$ rails new app-name -m https://raw.githubusercontent.com/harvard-library/Curiosity/harvard_development/template.rb
```

or from an existing Rails application:

```
$ rake app:template LOCATION=https://raw.githubusercontent.com/harvard-library/Curiosity/harvard_development/template.rb
```
